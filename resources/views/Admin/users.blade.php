...
@section('title', config('adminlte.title').' | '.__('auth.users'))
                      ...
                      <tbody>
                        ...
                        <tr @if($r->status=='0') style="background-color: red;" @endif>
                          ...
                          <td>
                            ...
                            @if($roles->e=="1")<button data-rowid="{{$r->id}}" data-name="{{$r->name}}" data-email="{{$r->email}}" data-status="{{$r->status}}" data-phone="{{$r->phone}}" class="btn btn-xs btn-warning editButton"><i class="fa fa-edit"></i> {{ __('auth.edit') }}</button>@endif
